...
DROP TABLE dim_oraganizacional;
...
ALTER TABLE Dim_Oraganizacional COMMENT 'Tabela da dimensão Organizacional.';
...
ALTER TABLE Dim_Categoria COMMENT 'Tabela da dimensão Categoria.';
...
ALTER TABLE Dim_Marca COMMENT 'Tabela da dimensão Marca.';
...
ALTER TABLE Dim_Produto COMMENT 'Tabela da dimensão Produto.';
