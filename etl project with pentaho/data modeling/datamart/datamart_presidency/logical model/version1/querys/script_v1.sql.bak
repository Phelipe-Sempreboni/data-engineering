...
ALTER TABLE Produto COMMENT 'Tabela da dimensão Produto do modelo de OLAP da Presidência.';
...
ALTER TABLE Cliente COMMENT 'Tabela da dimensão Cliente do modelo de OLAP da Presidência.';
...
ALTER TABLE Tempo COMMENT 'Tabela da dimensão Tempo do modelo de OLAP da Presidência.';
...
ALTER TABLE Fabrica COMMENT 'Tabela de dimensão Fábrica do modelo de OLAP da Presidência.';
